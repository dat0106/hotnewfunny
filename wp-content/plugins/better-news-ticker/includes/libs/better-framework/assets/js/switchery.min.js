    ...
    require.register("switchery/switchery.js", function(exports, require, module){
        ...
        Switchery.prototype.setPosition = function (clicked) {
            ...
            if (checked === true) {
                ...
                // honar Fix
                _offsetWidth= 0;
                if(jack.offsetWidth==0){
                    _offsetWidth = 30;
//                    console.log('asd: '+_offsetWidth);
                }
                if (window.getComputedStyle){
                    if(_offsetWidth==30)
                        jack.style.left = parseInt(window.getComputedStyle(switcher).width) - _offsetWidth + 'px';
                    else
