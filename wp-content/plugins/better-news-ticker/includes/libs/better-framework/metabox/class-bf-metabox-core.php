...
class BF_Metabox_Core {
    ...
    /**
     * Used to add action for constructing the meta box, runs on BF_Metabox_Core->Init method,
     *
     * @since	1.0
     * @access	public
     */
    ...
    public function can_output( $config ){
        ...
        $post_id = BF_Helper::get_current_post_id_admin();
        ...
        $current_post_type = BF_Helper::get_current_post_type_admin();
