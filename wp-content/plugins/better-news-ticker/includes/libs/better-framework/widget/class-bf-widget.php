...
class BF_Widget extends WP_Widget{
    ...
    public function update($new_instance, $old_instance){
        ...
        $def['heading_color'] = apply_filters( 'better-framework/widgets/options/general/heading_color/default' , '' );
        $def['heading_bg'] = apply_filters( 'better-framework/widgets/options/general/heading_bg/default' , '' );
