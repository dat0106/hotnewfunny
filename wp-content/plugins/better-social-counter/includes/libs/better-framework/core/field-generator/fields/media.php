...
$a = Better_Framework::html()->add( 'a' )->class( 'bf-button' )->class( 'bf-button bf-media-upload-btn button' )->data( 'mediatitle', $media_title )->data( 'buttontext', $button_text );
$a->text( __( 'Upload', 'better-studio' ) );
