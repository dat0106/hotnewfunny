...
/**
 * BetterMag Content Listing 8
 */
class BM_Content_Listing_8_Shortcode extends BM_Listing_Shortcode{

    function __construct(  ){

        $id = 'bm_content_listing_8';

        $this->name = __( 'Content Listing 8', 'better-studio');

        $this->description = __( '1 Blog , 2 Column thumbnail listing', 'better-studio' );
    ...
    function display( array $atts  , $content = '' ){
        ...
        Better_Mag::posts()->set_query( new WP_Query( apply_filters( 'better-mag/content-listing-8/args', $args ) ) );

        $this->the_block_title( $atts );

        ?>
        <div class="row block-listing block-listing-8">
            <div class="col-lg-12 col-md-12 col-sm-12 col-xs-12">
                ...
                <div class="row">
                    ...
                    <div class="col-lg-6 col-md-6 col-sm-12 hidden-xs"><?php
...
class WPBakeryShortCode_bm_content_listing_8 extends BM_VC_Shortcode_Extender { }