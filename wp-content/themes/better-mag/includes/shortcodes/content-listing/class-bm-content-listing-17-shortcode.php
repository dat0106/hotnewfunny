<?php
/**
 * BetterMag Content Listing 17
 */
class BM_Content_Listing_17_Shortcode extends BM_Listing_Shortcode{

    function __construct(  ){

        $id = 'bm_content_listing_17';

        $this->name = __( 'Content Listing 17', 'better-studio');

        $this->description = __( '2 Column of different category', 'better-studio' );
    ...
    function display( array $atts  , $content = '' ){
        ...
        ?>
        <div class="row block-listing block-listing-17">
            <div class="col-lg-6 col-md-6 col-sm-6 col-xs-12"><?php
                ...
                Better_Mag::posts()->set_query( new WP_Query( apply_filters( 'better-mag/content-listing-17/args', $args ) ) );
...
class WPBakeryShortCode_bm_content_listing_17 extends BM_VC_Shortcode_Extender { }