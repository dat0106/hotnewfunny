...
/**
 * BetterMag Content Listing 9
 */
class BM_Content_Listing_9_Shortcode extends BM_Listing_Shortcode{

    function __construct(  ){

        $id = 'bm_content_listing_9';

        $this->name = __( 'Content Listing 9', 'better-studio');

        $this->description = __( '1 Blog , 3 Column simple listing', 'better-studio' );
    ...
    function display( array $atts  , $content = '' ){
        ...
        Better_Mag::posts()->set_query( new WP_Query( apply_filters( 'better-mag/content-listing-9/args', $args ) ) );
        ...
        <div class="row block-listing block-listing-12">
            <div class="col-lg-12 col-md-12 col-sm-12 col-xs-12">
                ...
                <div class="row">
                    ...
                    ?></div>
                    <div class="col-lg-4 col-md-4 col-sm-6 hidden-xs"><?php
...
class WPBakeryShortCode_bm_content_listing_9 extends BM_VC_Shortcode_Extender { }