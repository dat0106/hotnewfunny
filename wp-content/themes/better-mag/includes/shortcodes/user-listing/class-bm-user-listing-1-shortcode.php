...
class BM_User_Listing_1_Shortcode extends BF_Shortcode {
    ...
    function the_block_title( &$atts, &$user_query ){
        ...
        if( $atts['show_total'] ){
            ...
            $other_links = ' <span class="total-count">' .__( 'Total: ', 'better-studio' ) . $user_query->total_users . '</span>' ;
    ...
    function display(array $atts, $content = ''){
        ...
        switch( $atts['column'] ){
            ...
            case 2:
                $before = '<div class="col-lg-6 col-md-12 col-sm-12 col-xs-12">';
                break;

            case 1:
            default:
                $before = '<div class="col-lg-12 col-md-12 col-sm-12 col-xs-12">';

        }


        ?>
        <div class="row user-listing user-listing-1"><?php
