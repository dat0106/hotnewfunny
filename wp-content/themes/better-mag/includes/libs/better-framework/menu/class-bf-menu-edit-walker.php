...
class BF_Menu_Edit_Walker extends Walker_Nav_Menu_Edit{
    ...
    public function get_custom_fields($item, $depth = 0) {
        ...
        $output = '<div class="better-menu-container">
        <div class="better-menu-box-title"><a class="button button-primary menu-save" href="javascript:void(0)">Show Advanced Fields?</a></div>
        <div class="better-menu-fields">';
